    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600">
          Saldos reales por cuenta, divisa y formato (<code className="text-xs bg-gray-100 px-1 rounded">movement_lines</code>). Distinto del{' '}
      ...
      <div className="flex flex-wrap items-end gap-3">
        <div>
          <label className="block text-xs font-medium text-gray-500 mb-0.5">Ver al día</label>
          <input
            type="date"
            value={asOf}
      ...
      {!loading && positions.length > 0 && (
        <div className="space-y-4">
          {positions.map((acc) => (
            <div key={acc.account_id} className="border border-gray-200 rounded-lg overflow-hidden bg-white">
