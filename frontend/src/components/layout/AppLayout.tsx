...
const NAV_ITEMS: NavItemDef[] = [
  ...
  },
  {
    ...
    permission: 'operations.create_header',
    icon: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  {
    to: '/posicion-integral-mock',
    label: 'Integral (mock UI)',
    permission: 'cash_position.view',
    icon: (
      <>
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.325.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 0 1 1.37.49l1.008 2.222c.193.425.05.924-.325 1.176l-.993.738a1.125 1.125 0 0 0-.522 1.042v.55c0 .608.31 1.172.822 1.506l.993.738c.375.252.518.75.325 1.176l-1.008 2.222a1.125 1.125 0 0 1-1.37.49l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.57 6.57 0 0 1-.22.128c-.331.183-.581.495-.644.869l-.213 1.28c-.09.543-.56.941-1.11.941h-2.594c-.55 0-1.02-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 0 1-.22-.127c-.325-.196-.72-.257-1.075-.124l-1.217.456a1.125 1.125 0 0 1-1.37-.49l-1.008-2.223a1.125 1.125 0 0 1 .326-1.176l.994-.738c.512-.334.822-.898.822-1.506v-.55a1.125 1.125 0 0 0-.522-1.042l-.994-.738a1.125 1.125 0 0 1-.326-1.176l1.008-2.223a1.125 1.125 0 0 1 1.37-.49l1.217.456c.355.133.75.072 1.076-.124.072-.044.146-.087.22-.128.332-.183.582-.495.644-.869l.214-1.281Z"
        />
