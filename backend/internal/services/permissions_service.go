...
var permissionCatalog = []repositories.PermissionCatalogItem{
	...
	{Key: "operations.saldo_inicial_caja.execute", Module: "operations", Label: "Registrar saldo inicial de caja"},
	...
	{Key: "pending.opening.create", Module: "pending", Label: "Registrar pendiente inicial (apertura)"},
